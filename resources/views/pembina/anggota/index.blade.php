            ...
            <tr>
                <td>
                    <div class="d-flex align-items-center">
                        ...
                        <img src="{{ asset('images/profile/' . $user->profile->foto) }}" alt="Foto {{ $user->name }}"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-body text-center p-5">
                ...
                <h4 class="modal-title fw-bold mb-3" id="deleteModalLabel{{ $user->id }}">Are you sure to delete this?
                </h4>
                <p class="text-muted mb-4">This action cannot be undone. The member "{{ $user->name }}" will be
                    permanently removed from "{{ $ekskul->nama_ekskul }}".</p>
                <div class="d-flex gap-3 justify-content-center">
                    <form action="{{ route('pembina.anggota.destroy', [$ekskul->id, $user->id]) }}" method="POST"
                        class="d-inline">
                        @csrf
                        @method('DELETE')
